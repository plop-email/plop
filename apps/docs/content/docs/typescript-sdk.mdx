...
The `@plop/sdk` package provides a typed, zero-dependency client for the Plop API. It works with Node.js 18+ and any test framework.
...
- [npm package](https://www.npmjs.com/package/@plop/sdk)
