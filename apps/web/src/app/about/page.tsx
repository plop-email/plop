        ...
        <div className="space-y-12">
          <section>
            ...
            <p className="text-[#A3A7AE] leading-relaxed">
              Plop exists to make inbound email dependable for modern teams. Too
              often, email sits outside the product stack, making support flows,
              onboarding, and testing unpredictable. We are building a platform
              that lets teams route, store, and automate email with the same
              clarity they expect from the rest of their systems.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[#A3A7AE] leading-relaxed">
              ...
              customer base, Plop keeps email workflows visible and repeatable,
              without standing up your own mail stack.
            </p>
          </section>
          ...
          <div className="flex items-center pt-6 border-t border-white/12">
            <div className="space-y-1">
              ...
              <p className="text-sm text-[#A3A7AE]">Founder &amp; CEO, Plop</p>
            </div>
          </div>
        </div>
      </Section>
