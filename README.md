...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@plop/sdk"><img src="https://img.shields.io/npm/v/@plop/sdk?style=flat-square&label=@plop/sdk&color=B8FF2C" alt="npm" /></a>
...
| SDK | Package | GitHub |
|-----|---------|--------|
| TypeScript | [`@plop/sdk`](https://www.npmjs.com/package/@plop/sdk) | [plop-email/plop-ts](https://github.com/plop-email/plop-ts) |
